    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col items-center py-4 px-4 print:bg-white print:text-black print:p-0 print:m-0">
      ...
      <div className="no-print w-full max-w-4xl mb-4 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900 text-slate-100 p-4 rounded-xl border border-slate-800 shadow-md">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold">
            معاينة الشهادة الطبية الرسمية قبل الطباعة. تم تعديل المسافات لتناسب صفحة واحدة تماماً.
          </span>
        </div>
      ...
      <div className="print-page bg-white text-black shadow-xl flex flex-col" dir="rtl">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1 grid grid-cols-3 gap-2 pt-2 text-[14px] font-bold text-black">
          ...
          <div className="flex flex-col items-center mr-8">
            <div className="border border-black flex items-center justify-center text-[14px] text-black font-bold mb-1" style={{ width: '40mm', height: '60mm' }}>
              <span dir="ltr">4*6</span>
            </div>
            <span className="text-[12px] text-black font-bold mt-1">ختم شعار الجمهورية</span>
          </div>
        </div>

        {/* Section 1: Basic Information */}
        <div className="mb-5">
          <h3 className="text-[16px] font-bold text-black mb-3">البيانات الأساسية</h3>
          <div className="grid grid-cols-3 gap-y-4 text-[14px] font-bold text-black">
        ...
        <div className="mb-5">
          <h3 className="text-[16px] font-bold text-black mb-3">الفحوصات الطبية</h3>
          <div className="grid grid-cols-3 gap-y-4 text-[14px] font-bold text-black">
        ...
        <div className="mb-6">
          <h4 className="text-[14px] font-bold text-black mb-4 text-right underline underline-offset-4" dir="ltr">Hb Electrophoresis :</h4>
          <div className="flex justify-between items-center text-center text-[14px] font-bold text-black px-12" dir="ltr">
            <div>
        ...
        <div className="mb-6">
          <h3 className="text-[15px] font-bold text-black mb-4 text-right">إقرار المنتفع/المنتفعة بإعلامه بنتيجة الفحص وتوصيات الطبيب</h3>
          
          <div className="flex justify-between items-center text-black">
            <div className="flex-1 grid grid-cols-2 gap-y-4 text-[14px] font-bold">
            ...
            <div className="flex flex-col items-center ml-16">
              ...
              <span className="text-[12px] font-bold">ختم شعار الجمهورية</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center text-[14px] font-bold text-black mb-2">
          ...
          <p className="text-[14px] font-bold text-black leading-snug text-justify">
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center text-[14px] font-bold text-black mt-6 mb-2">
          ...
          <div className="flex flex-col items-center justify-center border-r-2 border-l-2 border-slate-300 px-12 py-2 h-full">
            <div className="w-[60px] h-[60px] rounded-full border border-black mb-2"></div>
            <span className="text-[14px] font-bold">بصمة الإبهام</span>
          </div>
        ...
        {/* Footer Block */}
        <div className="flex justify-between items-end text-black pt-2 mt-4">
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white p-1">
              {currentUrl ? (
                ...
                <div className="h-[80px] w-[80px] bg-slate-100 flex items-center justify-center text-[10px] text-slate-400">
                  QR
                </div>
              )}
            </div>
            <span className="mt-1 font-bold text-[12px]">
