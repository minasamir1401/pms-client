      ...
      <div className="flex-grow flex flex-col items-center py-6 px-4 overflow-auto print:p-0 print:m-0 print:block">
        ...
        >
          ...
          <div className="flex justify-between items-start relative pt-2">
            ...
            <div className="flex flex-col items-center ml-[40px]" style={{ direction: 'ltr', minWidth: '90px' }}>
          ...
          <div className="grid grid-cols-10 gap-2 mb-1 mt-0">
            ...
            <div className="col-span-3 font-bold text-[11pt] flex items-center gap-1 whitespace-nowrap mr-[-60px]">
          ...
          <div className="mt-1 w-full flex items-start gap-4" style={{ direction: 'ltr', paddingLeft: '55px' }}>
            ...
            <div className="flex w-[95%] justify-between pr-10 mt-[30px] ml-[-15px]">
          ...
          <div className="w-full">
            ...
            <div className="bg-white w-full">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-3 flex flex-col items-center mr-[-120px]">
                ...
                <div className="mt-1">
                    {isEditingText ? (
                      ...
                      <div className="mr-3 text-[9pt] leading-relaxed w-full font-normal">
                        <div>بأنه قد تم إعلامى بنتيجة الفحص الطبى والتوصيات الطبية المذكورة سابقا وقد تلقيت المشورة الخاصة بحالتى الصحية وألتزم بإعلام طرف الزواج</div>
                        <div>الأخر قبل إجراءات الزواج وأصبحت بذلك مسئول عما يترتب على ذلك دون أدنى مسئولية على المنشأة الصحية والفريق الطبى الذى يمثلها .</div>
                      </div>
                    ) : (
