      ...
      <div className="print-page bg-white text-black shadow-xl flex flex-col" dir="rtl">
        ...
        <div className="flex justify-between items-center mb-6 mt-2">
          ...
          <div className="flex flex-col items-center w-[140px]">
            <img src="/images/Ministry of Health and population (5).png" alt="شعار وزارة الصحة" className="w-[140px] h-[140px] object-contain" onError={(e) => { e.currentTarget.style.display = 'none'; e.currentTarget.nextElementSibling?.classList.remove('hidden'); }} />
            <div className="hidden w-[140px] h-[140px] border-2 border-dashed border-gray-300 flex items-center justify-center text-[10px] text-center text-gray-400 font-bold">
              شعار<br/>الوزارة
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            <div className="border border-black flex items-center justify-center text-[14px] text-black font-bold mb-1" style={{ width: '30mm', height: '35mm' }}>
